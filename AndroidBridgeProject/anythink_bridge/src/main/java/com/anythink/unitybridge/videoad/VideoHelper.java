        ...
        mRewardVideoAd.setAdListener(new ATRewardVideoListener() {
            ...
            public void onRewardedVideoAdPlayStart(ATAdInfo adInfo) {
                ...
                TaskManager.getInstance().run_proxy(new Runnable() {
                    ...
                    public void run() {
                        if (mListener != null) {
                            mListener.onRewardedVideoAdPlayStart(mUnitId);
                        }
                    }
                });
            }
            ...
            public void onRewardedVideoAdPlayEnd(ATAdInfo adInfo) {
                ...
                TaskManager.getInstance().run_proxy(new Runnable() {
                    ...
                    public void run() {
                        if (mListener != null) {
                            mListener.onRewardedVideoAdPlayEnd(mUnitId);
                        }
                    }
                });
            }
            ...
            public void onRewardedVideoAdClosed(ATAdInfo adInfo) {
                ...
                TaskManager.getInstance().run_proxy(new Runnable() {
                    ...
                    public void run() {
                        if (mListener != null) {
                            mListener.onRewardedVideoAdClosed(mUnitId, isReward);
                        }
                    }
                });
            }
            ...
            public void onRewardedVideoAdPlayClicked(ATAdInfo adInfo) {
                ...
                TaskManager.getInstance().run_proxy(new Runnable() {
                    ...
                    public void run() {
                        if (mListener != null) {
                            mListener.onRewardedVideoAdPlayClicked(mUnitId);
                        }
                    }
                });
            }
