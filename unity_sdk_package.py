...
Unity_NonChina_CrossPlatform_Core = ["Api", "Common", "Platform", "Thrid", "Plugins/Android/NonChina/androidx_plugin", "Plugins/Android/NonChina/anythink_base",
                                     "Plugins/Android/NonChina/google_service", "Plugins/Android/NonChina/mediation_plugin", "Plugins/Android/anythink_bridge.aar", "Plugins/iOS/Core"]

Unity_China_CrossPlatform_Core = ["Api", "Common", "Platform", "Thrid", "Plugins/Android/China/support_v4",
                                  "Plugins/Android/China/anythink_base", "Plugins/Android/China/mediation_plugin", "Plugins/Android/anythink_bridge.aar", "Plugins/iOS/Core"]


Unity_Android_NonChina_Core = ["Api", "Common", "Platform/ATAdsClientFactory.cs", "Platform/Android", "Thrid", "Plugins/Android/NonChina/androidx_plugin",
                               "Plugins/Android/NonChina/anythink_base", "Plugins/Android/NonChina/google_service", "Plugins/Android/NonChina/mediation_plugin", "Plugins/Android/anythink_bridge.aar"]

Unity_Android_China_Core = ["Api", "Common", "Platform/ATAdsClientFactory.cs", "Platform/Android", "Thrid", "Plugins/Android/China/support_v4",
                            "Plugins/Android/China/anythink_base", "Plugins/Android/China/mediation_plugin", "Plugins/Android/anythink_bridge.aar"]

Unity_iOS_Core = ["Api", "Common", "Platform/ATAdsClientFactory.cs",
                  "Platform/iOS", "Thrid", "Plugins/iOS/Core"]
...
Mintegral_And_NonChina_File_List = [
    Android_NonChina_Network_Base + "mintegral"]
...
Mediation_List = ["Baidu", "GDT", "Ksyun", "KuaiShou", "Oneway", "Sigmob",
...
def buildCrossChinaPlatform():
    ...
    runcmd("Unity -batchmode -projectPath AnyThinkUnitySDK -exportPackage " +
           core_paths + CrossPlatform_China_Output_Path + "AnyThinkCore.unitypackage -quit")
    ...
    for key in Mediation_List:
        ...
        if len(Temp_List) != 0:
            ...
            runcmd("Unity -batchmode -projectPath AnyThinkUnitySDK -exportPackage " + paths +
                   CrossPlatform_China_Output_Path + "AnyThink" + key + ".unitypackage -quit")
...
def buildCrossNonChinaPlatform():
    ...
    for filePath in Unity_NonChina_CrossPlatform_Core:
        core_paths = core_paths + Base_Dir + filePath + " "
        runcmd("Unity -batchmode -projectPath AnyThinkUnitySDK -exportPackage " +
               core_paths + CrossPlatform_NonChina_Output_Path + "AnyThinkCore.unitypackage -quit")
    ...
    for key in Mediation_List:
        ...
        if len(Temp_List) != 0:
            for filePath in Temp_List:
                paths = paths + Base_Dir + filePath + " "
            runcmd("Unity -batchmode -projectPath AnyThinkUnitySDK -exportPackage " + paths +
                   CrossPlatform_NonChina_Output_Path + "AnyThink" + key + ".unitypackage -quit")
...
def buildAndroid():
    ...
    for key in Android_China_Package_Map:
        ...
        for filePath in Temp_List:
            paths = paths + Base_Dir + filePath + " "
        runcmd("Unity -batchmode -projectPath AnyThinkUnitySDK -exportPackage " +
               paths + China_Output_Path + "AnyThink" + key + ".unitypackage -quit")
    ...
    for key in Android_NonChina_Package_Map:
        ...
        for filePath in Temp_List:
            paths = paths + Base_Dir + filePath + " "
        runcmd("Unity -batchmode -projectPath AnyThinkUnitySDK -exportPackage " +
               paths + NonChina_Output_Path + "AnyThink" + key + ".unitypackage -quit")
...
def buildiOS():
    ...
    for key in iOS_Package_Map:
        ...
        for filePath in Temp_List:
            paths = paths + Base_Dir + filePath + " "
        runcmd("Unity -batchmode -projectPath AnyThinkUnitySDK -exportPackage " +
               paths + iOS_Output_Path + "AnyThink" + key + ".unitypackage -quit")
